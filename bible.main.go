...
func bible(text string,user_msgid string,reply_mode string) (string, string, string, string) {
	...
	case "馬索拉聖經","希伯來文聖經","bhs","Bhs","BHS","ＢＨＳ","Ｂｈｓ","ｂｈｓ":
		log.Print(reg.ReplaceAllString(text, "$3"))
		switch reg.ReplaceAllString(text, "$3") {
			case "Gen","Genesis","創","創世","創世紀","創世記","Ge","ge","gen","창세기","Sáng-thế Ký","Бытие":
				bible_short_name = "創"
			...
			case "Gen","Genesis","創","創世","創世紀","創世記","Ge","ge","gen","창세기","Sáng-thế Ký","Бытие":
				...
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("創","創世記", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("創","創世記", chap_string, sec_string,"rukai")
						}
				}
			case "ex","Ex","Exodus","埃及","出","出埃及","出埃及記","출애굽기","エジプト","出エジプト","出エジプト記","Xuất Ê-díp-tô Ký","Исход":
				bible_short_name = "出"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("出","出埃及記", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("出","出埃及記", chap_string, sec_string,"rukai")
						}
				}
			case "Lev","Leviticus","利","利未","利未記","Le","le","Левит","Lê-vi Ký","レビ記","レビ","레위기":
				bible_short_name = "利"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("利","利未記", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("利","利未記", chap_string, sec_string,"rukai")
						}
				}
			case "Num","Numbers","民","民數","民數記","Nu","nu","민수기","民数","民数記","Dân-số Ký","Числа":
				bible_short_name = "民"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("民","民數記", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("民","民數記", chap_string, sec_string,"rukai")
						}
				}
			case "Deut","Deuteronomy","申","申命","申命記","De","de","신명기","Phục-truyền Luật-lệ Ký","Второзаконие":
				bible_short_name = "申"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("申","申命記", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("申","申命記", chap_string, sec_string,"rukai")
						}
				}
			case "Josh","Joshua","約書亞","約書亞記","Jos","jos","여호수아","ヨシュア記","ヨシュア","Giô-suê","Книга Иисуса Навина":
				bible_short_name = "書"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("書","約書亞記", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("書","約書亞記", chap_string, sec_string,"rukai")
						}
				}
			case "Judg","Judges","士","士師","士師記","Jud","jud","jdg","Jdg","Книга Судей израилевых","Các Quan Xét","사사기":
				bible_short_name = "士"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("士","士師記", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("士","士師記", chap_string, sec_string,"rukai")
						}
				}
			case "Ruth","路得","路得記","Ru","ru","Rut","rut","룻기","ルツ","ルツ記","Ru-tơ","Книга Руфи":
				bible_short_name = "得"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("得","路得記", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("得","路得記", chap_string, sec_string,"rukai")
						}
				}
			case "1 Sam","First Samuel","撒上","撒母耳記上","1Sa","1sa","サムエル記上","サムエル上","サム上","사무엘상","1 Sa-mu-ên","Первая книга Царств":
				bible_short_name = "撒上"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("撒上","撒母耳記上", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("撒上","撒母耳記上", chap_string, sec_string,"rukai")
						}
				}
			case "2 Sam","Second Samuel","撒下","撒母耳記下","2Sa","2sa","사무엘하","サムエル記下","サムエル下","サム下","2 Sa-mu-ên","Вторая книга Царств":
				bible_short_name = "撒下"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("撒下","撒母耳記下", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("撒下","撒母耳記下", chap_string, sec_string,"rukai")
						}
				}
			case "1 Kin","First Kings","王上","列王上","列王紀上","列王記上","1Ki","1ki","열왕기상","Третья книга Царств","1 Các Vua":
				bible_short_name = "王上"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("王上","列王紀上", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("王上","列王紀上", chap_string, sec_string,"rukai")
						}
				}
			case "2 Kin","Second Kings","王下","列王下","列王記下","列王紀下","2Ki","2ki","열왕기하","2 Các Vua","Четвертая книга Царств":
				bible_short_name = "王下"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("王下","列王紀下", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("王下","列王紀下", chap_string, sec_string,"rukai")
						}
				}
			case "1 Chr","First Chronicles","歷上","代上","歷代志上","歷代上","1Ch","1ch","Первая книга Паралипоменон","1 Sử-ký","歴上","歴代上","歴代志上","역대상":
				bible_short_name = "代上"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("代上","歷代志上", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("代上","歷代志上", chap_string, sec_string,"rukai")
						}
				}
			case "2 Chr","Second Chronicles","代下","歷下","歷代下","歷代志下","2Ch","2ch","역대하","歴代志下","歴代下","歴下","2 Sử-ký","Вторая книга Паралипоменон":
				bible_short_name = "代下"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("代下","歷代志下", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("代下","歷代志下", chap_string, sec_string,"rukai")
						}
				}
			case "Ezra","拉","以斯拉","以斯拉記","Ezr","ezr","Первая книга Ездры","Ê-xơ-ra","エズラ","エズラ記","에스라":
				bible_short_name = "拉"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("拉","以斯拉記", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("拉","以斯拉記", chap_string, sec_string,"rukai")
						}
				}
			case "Neh","Nehemiah","尼","尼希米","尼希米記","Ne","ne","느헤미야","ネヘミヤ書","ネヘミヤ","Nê-hê-mi","Книга Неемии":
				bible_short_name = "尼"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("尼","尼希米記", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("尼","尼希米記", chap_string, sec_string,"rukai")
						}
				}
			case "Esth","Esther","斯","以斯帖","以斯帖記","Es","est","Есфирь","Ê-xơ-tê","エステル","エステル記","에스더":
				bible_short_name = "斯"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("斯","以斯帖記", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("斯","以斯帖記", chap_string, sec_string,"rukai")
						}
				}
			case "Job","job","伯","約伯","約伯記","Книга Иова","Gióp","ヨブ","ヨブ記","욥기":
				bible_short_name = "伯"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("伯","約伯記", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("伯","約伯記", chap_string, sec_string,"rukai")
						}
				}
			case "Ps","Psalms","詩","詩篇","ps","시편","Thi-thiên","Псалтирь":
				bible_short_name = "詩"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("詩","詩篇", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("詩","詩篇", chap_string, sec_string,"rukai")
						}
				}
			case "Prov","Proverbs","箴","箴言","Pr","pr","Притчи Соломона","Châm-ngôn","잠언":
				bible_short_name = "箴"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("箴","箴言", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("箴","箴言", chap_string, sec_string,"rukai")
						}
				}
			case "Eccl","Ecclesiastes","傳","傳道","傳道書","Ec","ec","Книга Екклезиаста","или Проповедника","Truyền-đạo","伝道の書","伝道","伝","伝道書","전도서":
				bible_short_name = "傳"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("傳","傳道書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("傳","傳道書", chap_string, sec_string,"rukai")
						}
				}
			case "Song","Song of Solomon","歌","雅歌","So","so","sng","Sng","Песнь песней Соломона","Nhã-ca","아가":
				bible_short_name = "歌"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("歌","雅歌", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("歌","雅歌", chap_string, sec_string,"rukai")
						}
				}
			case "Is","Isaiah","賽","以賽","以賽亞","以賽亞書","Isa","isa","Книга пророка Исаии","Ê-sai","イザヤ書","イザヤ","이사야":
				bible_short_name = "賽"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("賽","以賽亞書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("賽","以賽亞書", chap_string, sec_string,"rukai")
						}
				}
			case "Jer","Jeremiah","耶","耶利米","耶利米書","jer","예레미야","エレミヤ","エレミヤ書","Giê-rê-mi","Книга пророка Иеремии":
				bible_short_name = "耶"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("耶","耶利米書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("耶","耶利米書", chap_string, sec_string,"rukai")
						}
				}
			case "Lam","Lamentations","哀","哀歌","耶利米哀歌","La","lam","예레미야애가","Ca-thương","Плач Иеремии":
				bible_short_name = "哀"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("哀","耶利米哀歌", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("哀","耶利米哀歌", chap_string, sec_string,"rukai")
						}
				}
			case "Ezek","Ezekiel","結","以西結","以西結書","Eze","eze","에스겔","エゼキエル書","エゼキエル","Ê-xê-chi-ên","Книга пророка Иезекииля":
				bible_short_name = "結"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("結","以西結書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("結","以西結書", chap_string, sec_string,"rukai")
						}
				}
			case "Dan","Daniel","但","但以理","但以理書","Da","da","Книга пророка Даниила","Đa-ni-ên","ダニエル書","ダニエル","다니엘":
				bible_short_name = "但"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("但","但以理書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("但","但以理書", chap_string, sec_string,"rukai")
						}
				}
			case "Hos","Hosea","何","何西","何西阿","何西阿書","Ho","ho","Книга пророка Осии","Ô-sê","ホセア書","ホセア","호세아":
				bible_short_name = "何"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("何","何西阿書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("何","何西阿書", chap_string, sec_string,"rukai")
						}
				}
			case "Joel","珥","約珥","約珥書","Joe","joe","Книга пророка Иоиля","Giô-ên","ヨエル書","ヨエル","요엘":
				bible_short_name = "珥"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("珥","約珥書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("珥","約珥書", chap_string, sec_string,"rukai")
						}
				}
			case "Amos","摩","阿摩司書","Am","am","Книга пророка Амоса","A-mốt","アモス書","アモス","아모스":
				bible_short_name = "摩"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("摩","阿摩司書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("摩","阿摩司書", chap_string, sec_string,"rukai")
						}
				}
			case "Obad","Obadiah","俄","俄巴底亞","俄巴底亞書","Ob","ob","오바댜","オバデヤ書","オバデヤ","Áp-đia","Книга пророка Авдия":
				bible_short_name = "俄"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("俄","俄巴底亞書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("俄","俄巴底亞書", chap_string, sec_string,"rukai")
						}
				}
			case "Jon","Jonah","拿","約拿","約拿書","jon","요나","ヨナ書","ヨナ","Giô-na","Книга пророка Ионы":
				bible_short_name = "拿"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("拿","約拿書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("拿","約拿書", chap_string, sec_string,"rukai")
						}
				}
			case "Micah","彌","彌迦","彌迦書","Mic","mic","Книга пророка Михея","Mi-chê","ミカ書","ミカ","미가":
				bible_short_name = "彌"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("彌","彌迦書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("彌","彌迦書", chap_string, sec_string,"rukai")
						}
				}
			case "Nah","Nahum","鴻","那鴻","那鴻書","Na","na","Книга пророка Наума","Na-hum","ナホム書","ナホム","나훔":
				bible_short_name = "鴻"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("鴻","那鴻書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("鴻","那鴻書", chap_string, sec_string,"rukai")
						}
				}
			case "Habakkuk","哈","哈巴","哈巴谷","哈巴谷書","Hab","hab","Книга пророка Аввакума","Ha-ba-cúc","ハバクク書","ハバクク","ハバ","クク","ハバ書","하박국":
				bible_short_name = "哈"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("哈","哈巴谷書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("哈","哈巴谷書", chap_string, sec_string,"rukai")
						}
				}
			case "Zeph","Zephaniah","番","西番雅","西番雅書","Zep","zep","스바냐","ゼパニヤ書","ゼパニヤ","Sô-phô-ni","Книга пророка Софонии":
				bible_short_name = "番"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("番","西番雅書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("番","西番雅書", chap_string, sec_string,"rukai")
						}
				}
			case "Haggai","該","哈該","哈該書","Hag","hag","학개","ハガイ書","ハガイ","A-ghê","Книга пророка Аггея":
				bible_short_name = "該"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("該","哈該書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("該","哈該書", chap_string, sec_string,"rukai")
						}
				}
			case "Zech","Zechariah","亞","撒迦利亞","撒迦利亞書","Zec","zec","Книга пророка Захарии","Xa-cha-ri","스가랴","ゼカリヤ書","ゼカリヤ":
				bible_short_name = "亞"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("亞","撒迦利亞書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("亞","撒迦利亞書", chap_string, sec_string,"rukai")
						}
				}
			case "Malachi","瑪","","瑪拉","瑪拉基","瑪拉基書","Mal","mal","말라기","マラキ書","マラキ","Ma-la-chi","Книга пророка Малахии":
				bible_short_name = "瑪"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("瑪","瑪拉基書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("瑪","瑪拉基書", chap_string, sec_string,"rukai")
						}
				}
			case "Matt","Matthew","太","馬太","馬太福音","Mt","mt","마태복음","マタイによる福音書","マタイ","マタイによる","Ma-thi-ơ","От Матфея святое благовествование":
				bible_short_name = "太"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("太","馬太福音", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("太","馬太福音", chap_string, sec_string,"rukai")
						}
				}
			case "Mark","可","馬可","馬可福音","Mr","mr","マルコによる福音書","マルコ","マルコによる","마가복음","Mác","От Марка святое благовествование":
				bible_short_name = "可"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("可","馬可福音", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("可","馬可福音", chap_string, sec_string,"rukai")
						}
				}
			case "Luke","路","路加","路加福音","Lu","lu","От Луки святое благовествование","Lu-ca","ルカによる福音書","ルカ","ルカによる","누가복음":
				bible_short_name = "路"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("路","路加福音", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("路","路加福音", chap_string, sec_string,"rukai")
						}
				}
			case "John","約","約翰","約翰福音","Joh","joh","От Иоанна святое благовествование","Giăng","ヨハネによる福音書","ヨハネ","ヨハネによる","요한복음":
				bible_short_name = "約"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("約","約翰福音", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("約","約翰福音", chap_string, sec_string,"rukai")
						}
				}
			case "Acts","徒","使徒","使徒行傳","Ac","ac","Деяния святых апостолов","Công-vụ Các Sứ-đồ","使徒行伝","사도행전":
				bible_short_name = "徒"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("徒","使徒行傳", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("徒","使徒行傳", chap_string, sec_string,"rukai")
						}
				}
			case "Rom","Romans","羅","羅馬","羅馬書","Ro","ro","Послание к Римлянам","Rô-ma","ローマ","ローマ人への手紙","로마서":
				bible_short_name = "羅"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("羅","羅馬書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("羅","羅馬書", chap_string, sec_string,"rukai")
						}
				}
			case "1 Cor","First Corinthians","林前","哥林多前","哥林多前書","1Co","1co","Первое послание к Коринфянам","1 Cô-rinh-tô","コリント人への第一の手紙","コリント一","コリント人への第一","고린도전서":
				bible_short_name = "林前"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("林前","哥林多前書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("林前","哥林多前書", chap_string, sec_string,"rukai")
						}
				}
			case "2 Cor","Second Corinthians","林後","哥林多後","哥林多後書","2Co","2co","Второе послание к Коринфянам","2 Cô-rinh-tô","コリント人への第二の手紙","コリント二","コリント人への第二の","고린도후서":
				bible_short_name = "林後"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("林後","哥林多後書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("林後","哥林多後書", chap_string, sec_string,"rukai")
						}
				}
			case "Gal","Galatians","加","加拉太","加拉太書","Ga","ga","Послание к Галатам","Ga-la-ti","ガラテヤ","ガラテヤ人への手紙","갈라디아서":
				bible_short_name = "加"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("加","加拉太書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("加","加拉太書", chap_string, sec_string,"rukai")
						}
				}
			case "Ephesians","弗","以弗所","以弗所書","Eph","eph","Послание к Ефесянам","Ê-phê-sô","エペソ人への手紙","エペソ","エペソ人","エペソ人の手紙","에베소서":
				bible_short_name = "弗"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("弗","以弗所書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("弗","以弗所書", chap_string, sec_string,"rukai")
						}
				}
			case "Phil","Philippians","腓","腓立","腓立比","腓立比書","Php","php","빌립보서","ピリピ","ピリピ人.ピリピ人への手紙","Послание к Филиппийцам","Phi-líp":
				bible_short_name = "腓"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("腓","腓立比書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("腓","腓立比書", chap_string, sec_string,"rukai")
						}
				}
			case "Col","col","Colossians","西","歌羅西","歌羅","歌羅西書","Послание к Колоссянам","Cô-lô-se","コロサイ人への手紙","コロサイ","コロ","골로새서":
				bible_short_name = "西"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("西","歌羅西書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("西","歌羅西書", chap_string, sec_string,"rukai")
						}
				}
			case "1 Thess","First Thessalonians","帖前","帖撒羅尼迦前","帖撒羅尼迦前書","1Th","1th","데살로니가전서","テサロニケ人への第一の手紙","テサ一","テサロニケ一","1 Tê-sa-lô-ni-ca","Первое послание к Фессалоникийцам (Солунянам)":
				bible_short_name = "帖前"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("帖前","帖撒羅尼迦前書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("帖前","帖撒羅尼迦前書", chap_string, sec_string,"rukai")
						}
				}
			case "2 Thess","Second Thessalonians","帖後","帖撒羅尼迦後","帖撒羅尼迦後書","2Th","2th","데살로니가후서","テサロニケ人への第二の手紙","テサ二","テサロニケ二","2 Tê-sa-lô-ni-ca","Второе послание к Фессалоникийцам (Солунянам)":
				bible_short_name = "帖後"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("帖後","帖撒羅尼迦後書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("帖後","帖撒羅尼迦後書", chap_string, sec_string,"rukai")
						}
				}
			case "1 Tim","First Timothy","提前","提摩太前","提摩太前書","1Ti","1ti","Первое послание к Тимофею","1 Ti-mô-thê","テモテヘの第一の手紙","テモテ一","디모데전서":
				bible_short_name = "提前"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("提前","提摩太前書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("提前","提摩太前書", chap_string, sec_string,"rukai")
						}
				}
			case "2 Tim","Second Timothy","提後","提摩太後","提摩太後書","2Ti","2ti","Второе послание к Тимофею","2 Ti-mô-thê","テモテヘの第二の手紙","テモテ二","디모데후서":
				bible_short_name = "提後"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("提後","提摩太後書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("提後","提摩太後書", chap_string, sec_string,"rukai")
						}
				}
			case "Titus","多","提多","提多書","Tit","tit","Послание к Титу","Tít","テトスヘの手紙","テトス","디도서":
				bible_short_name = "多"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("多","提多書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("多","提多書", chap_string, sec_string,"rukai")
						}
				}
			case "Philem","Philemon","門","腓利","腓利門","腓利門書","Phm","phm","Послание к Филимону","Phi-lê-môn","ピレモンヘの手紙","ピレモン","빌레몬서":
				bible_short_name = "門"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("門","腓利門書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("門","腓利門書", chap_string, sec_string,"rukai")
						}
				}
			case "Heb","Hebrews","來","希伯來","希伯來書","heb","Послание к Евреям","Hê-bơ-rơ","ヘブル人への手紙","ヘブル","히브리서":
				bible_short_name = "來"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("來","希伯來書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("來","希伯來書", chap_string, sec_string,"rukai")
						}
				}
			case "James","雅","雅各","雅各書","Jas","jas","Послание Иакова","Gia-cơ","ヤコブの手紙","ヤコブ","야고보서":
				bible_short_name = "雅"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("雅","雅各書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("雅","雅各書", chap_string, sec_string,"rukai")
						}
				}
			case "1 Pet","First Peter","彼前","彼得前","彼得前書","1Pe","1pe","Первое послание Петра","1 Phi-e-rơ","ペテロの第一の手紙","ペテロ一","베드로전서":
				bible_short_name = "彼前"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("彼前","彼得前書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("彼前","彼得前書", chap_string, sec_string,"rukai")
						}
				}
			case "2 Pet","Second Peter","彼後","彼得後","彼得後書","2Pe","2pe","Второе послание Петра","2 Phi-e-rơ","ペテロの第二の手紙","ペテロ","베드로후서":
				bible_short_name = "彼後"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("彼後","彼得後書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("彼後","彼得後書", chap_string, sec_string,"rukai")
						}
				}
			case "1 John","First John","約一","約翰一書","約翰1","約翰1書","1Jo","1jo","Первое послание Иоанна","1 Giăng","ヨハネの第一の手紙","ヨハネ一","요한일서":
				bible_short_name = "約一"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("約一","約翰一書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("約一","約翰一書", chap_string, sec_string,"rukai")
						}
				}
			case "2 John","second John","約二","約翰二書","約翰2","約翰2書","2Jo","Второе послание Иоанна","2 Giăng","ヨハネの第二の手紙","ヨハネ二","요한2서":
				bible_short_name = "約二"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("約二","約翰二書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("約二","約翰二書", chap_string, sec_string,"rukai")
						}
				}
			case "3 John","Third John","約三","約翰三書","約翰3","約翰3書","3Jo","3jo","Третье послание Иоанна","3 Giăng","ヨハネの第三の手紙","ヨハネ三","요한3서":
				bible_short_name = "約三"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("約三","約翰三書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("約三","約翰三書", chap_string, sec_string,"rukai")
						}
				}
			case "Jude","猶","猶大","猶大書","jude","Послание Иуды","Giu-đe","ユダの手紙","ユダ","유다서":
				bible_short_name = "猶"
				switch chap_string {
					...
					default:
						switch sec_string {
							case "":	//不知節的時候，知章
								print_string = Bible_print_string("猶","猶大書", chap_string, "1","rukai")
							default:
								print_string = Bible_print_string("猶","猶大書", chap_string, sec_string,"rukai")
						}
				}
			case "Rev","Revelation","啟","啟示","啟示錄","Re","re","ｒｅ","Ｒｅ","rev","Откровение ап. Иоанна Богослова (Апокалипсис)","Khải-huyền","ヨハネの黙示録","黙示録","요한계시록":
				bible_short_name = "啟"
...
//2017.10.27 
//https://bible.fhl.net/new/read.php?chineses=%E5%87%BA&nodic=0&chap=1
//舊約多 魯凱語聖經
//新約多 魯凱語聖經、鄒語聖經
//沒收 委辦譯本
//API http://bible.fhl.net/json/qb.php?chineses=%E5%89%B5&chap=2&sec=2-10&version=rukai
