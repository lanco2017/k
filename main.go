...
http://blog.kkcpct.org/#contact`
		...
		obj_message_family_focus := linebot.NewTemplateMessage(t_family_focus, LineTemplate_family_focus)
					...
					ImageURL_week_1 := "https://trello-attachments.s3.amazonaws.com/5897c415be467e461197bfbd/594ce5c05f008d8115f5c9ab/d5f2c102d37b3c40b891627611f3852b/index20170625_mini.jpg"
					obj_message_week_1 := linebot.NewImageMessage(ImageURL_week_1, ImageURL_week_1)

					this_week_text_2 := `本週週報（2017/06/25）：
https://s.kkcpct.org/2t6VG9p
...
以免誤認為垃圾信擋掉。`
		...
		next_week_msg := `本週主日預告（2017/06/18）
預定行事：
...
iCalendar Feeds 使用方法請參照：https://s.kkcpct.org/2mbZYER`
		...
		LineTemplate_nextweek_review := linebot.NewCarouselTemplate(
			...
			linebot.NewCarouselColumn(
				Bible_imageURL, "主日禮拜經文預習", "以下是本週（2017/06/25）的經文",
 				linebot.NewPostbackTemplateAction("台語禮拜 羅馬書 8:26-30","第一場預習","聖經 羅馬書 8:26-30"),
 				linebot.NewPostbackTemplateAction("華語禮拜 歷代志上 25:1-3","第一場預習","聖經 歷代志上 25:1-3"),
