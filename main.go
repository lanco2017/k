...
http://blog.kkcpct.org/#contact`
		...
		obj_message_family_focus := linebot.NewTemplateMessage(t_family_focus, LineTemplate_family_focus)
					...
					ImageURL_week_1 := "https://trello-attachments.s3.amazonaws.com/5897c415be467e461197bfbd/59c692e8e8fe804abde2d4a9/c0e512e02a6838289d7aa96f9bab5193/0924%E9%80%B1%E5%A0%B1%E9%A0%81%E5%B0%81%E9%9D%A2.jpg"
					obj_message_week_1 := linebot.NewImageMessage(ImageURL_week_1, ImageURL_week_1)

					this_week_text_2 := `本週週報（2017/09/24）：
https://s.kkcpct.org/2xntGQd
...
iCalendar Feeds 使用方法請參照：https://s.kkcpct.org/2mbZYER`
		...
		LineTemplate_nextweek_review := linebot.NewCarouselTemplate(
			...
			linebot.NewCarouselColumn(
				Bible_imageURL, "主日禮拜經文預習", "以下是本週（2017/09/17）的經文",
//  				linebot.NewPostbackTemplateAction("聯合禮拜 提摩太前書 4:6-15","第一場預習","聖經 提摩太前書 4:6-15"),
 				linebot.NewPostbackTemplateAction("台語禮拜 馬可福音 12:28-34","第一場預習","聖經 馬可福音 12:28-34"),
